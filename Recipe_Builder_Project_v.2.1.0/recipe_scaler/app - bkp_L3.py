...
def create_dish():
    ...
    # Save the created dish's ingredients list to the Final Product Recipes folder
    final_product_path = os.path.join('Final Product Recipes', f'{dish_name}.xlsx')
    with pd.ExcelWriter(final_product_path) as writer:
...
def created_product_history():
    # Logic to handle created product history page
    return render_template('created_product_history.html')
